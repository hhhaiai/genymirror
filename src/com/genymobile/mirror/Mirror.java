...
public final class Mirror {
    ...
    public static <T> T create(Class<T> clazz, ClassLoader targetClassLoader) {
    ...
    public static void validateMirrorDefinition(Class<?> mirrorDefinition) {
        validateMirrorDefinition(mirrorDefinition, mirrorDefinition.getClassLoader());
    }

    public static void validateMirrorDefinition(Class<?> mirrorDefinition, ClassLoader targetClassLoader) {
        Unwrapper unwrapper = new Unwrapper(targetClassLoader);
        ReflectionFinder finder = new ReflectionFinder(targetClassLoader, unwrapper);
